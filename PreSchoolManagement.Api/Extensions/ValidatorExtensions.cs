...
public static class ValidatorExtensions
{
    public static IServiceCollection AddValidatorServices(this IServiceCollection services)
    {
        ...
        services.AddValidatorsFromAssemblyContaining<CreateChairmanMasterCommandValidator>();       
        ...
        services.AddValidatorsFromAssemblyContaining<CreateSchoolStandardMappingCommandValidator>();
